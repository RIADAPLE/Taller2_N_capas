...
public interface PersonRepository  extends JpaRepository <Person,Integer >{
	 ...
	 /**
	    ...
	    **/
	    ...
	    Page<Person> findByFilters(Pageable page  ,@Param("idPerson")  Integer idPerson ,@Param("correo")  String correo ,@Param("direccion")  String direccion ,@Param("especialidad")  String especialidad ,@Param("fechaCreacion")  String fechaCreacion ,@Param("nombre")  String nombre ,@Param("telefono")  String telefono ,@Param("fkidDepartamentodepartamento")  Integer fkidDepartamentodepartamento ,@Param("fkidMunicipiomunicipio")  Integer fkidMunicipiomunicipio);
	    ...
	    **/
	    @Query(value ="SELECT  x.id_persona  ,  x.correo  ,  x.direccion  ,  x.especialidad  ,  x.fecha_creacion  ,  x.nombre  ,  x.telefono  ,  x.id_departamento  ,  x.id_municipio  "
	     ...
	     List<Object[]> findByFilters( @Param("idPerson")  Integer idPerson ,@Param("correo")  String correo ,@Param("direccion")  String direccion ,@Param("especialidad")  String especialidad ,@Param("fechaCreacion")  String fechaCreacion ,@Param("nombre")  String nombre ,@Param("telefono")  String telefono ,@Param("fkidDepartamentodepartamento")  Integer fkidDepartamentodepartamento ,@Param("fkidMunicipiomunicipio")  Integer fkidMunicipiomunicipio);
