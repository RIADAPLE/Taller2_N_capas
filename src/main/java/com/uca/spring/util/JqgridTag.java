...
public class JqgridTag extends SimpleTagSupport {
	...
	public String getUrlgrid() {
		return urlgrid;
	}

	public void setUrlgrid(String urlgrid) {
	...
	public String getNoloaddata() {
		return noloaddata;
	}

	public void setNoloaddata(String noloaddata) {
	...
	public String getEntitymaster() {
		return entitymaster;
	}

	public void setEntitymaster(String entitymaster) {
		this.entitymaster = entitymaster;
	}

	public String getEntitymasterfilter() {
		return entitymasterfilter;
	}

	public void setEntitymasterfilter(String entitymasterfilter) {
		this.entitymasterfilter = entitymasterfilter;
	}
